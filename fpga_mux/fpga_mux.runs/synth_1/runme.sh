...
HD_PWD='C:/F/Christ BS/sem6/vlsi/lab/fpga_mux/fpga_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_fpga.tcl
