...
HD_PWD='C:/F/Christ BS/sem6/vlsi/lab/and_fpga/and_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and_juan.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and_juan.tcl -notrace
