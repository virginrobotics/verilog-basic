...
HD_PWD='C:/F/Christ BS/sem6/vlsi/lab/and_fpga/and_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_juan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_juan.tcl
