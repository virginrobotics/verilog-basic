...
HD_PWD='C:/F/Christ BS/sem6/vlsi/lab/fourbit_syncup/fourbit_syncup.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbit_syncup.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourbit_syncup.tcl
