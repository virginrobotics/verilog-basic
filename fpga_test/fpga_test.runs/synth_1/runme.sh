...
HD_PWD='C:/F/Christ BS/sem6/vlsi/lab/fpga_test/fpga_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and_gpga_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and_gpga_test.tcl
