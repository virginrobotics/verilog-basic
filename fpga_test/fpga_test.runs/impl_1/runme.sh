...
HD_PWD='C:/F/Christ BS/sem6/vlsi/lab/fpga_test/fpga_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and_gpga_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and_gpga_test.tcl -notrace
